...
class DepthwiseXCorr(nn.Module):
    ...
    def forward(self, search, kernel):
        ...
        # print('############5',search_part.shape)
        # print('############6', kernel_part.shape)
        # exit()
...
class ModelBuilder(nn.Module):
    ...
    def forward(self, data,rank=None):
        ...
        # print('############1', template.shape)
        # print('############2', search.shape)
        ...
        # print('###############3',Nperbatch*cfg.DATASET.CATDOGHORSETK.NBATCH_SHAPREPREV)
        # exit()
