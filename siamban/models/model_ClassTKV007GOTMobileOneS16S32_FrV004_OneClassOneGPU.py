...
class ModelBuilder(nn.Module):
    def __init__(self,cfg=None):
        ...
        if cfg.BACKBONE.VARIANT=='s0':
            ...
            self.neck = AdjustAllLayerFPNAddFlagCenterCrop(in_channels=[256,1024],out_channels=[192,192],center_size=7)
        else:
            self.backbone = mobileones16outtwo(variant='s1')
            self.neck = AdjustAllLayerFPNAddFlagCenterCrop(in_channels=[512, 1280],out_channels=[192,192],center_size=7)
