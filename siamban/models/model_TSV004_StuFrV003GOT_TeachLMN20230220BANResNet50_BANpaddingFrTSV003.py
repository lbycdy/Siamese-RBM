...
class ModelBuilder(nn.Module):
    ...
    def forward(self, data,clstea,featclstea,featloctea,rank=None):
        ...
        zfaug = [zfaug[0] + zfaug[1] + zfaug[2], zfaug[1] + zfaug[2], zfaug[2]]
        xfaug = [xfaug[0] + xfaug[1] + xfaug[2], xfaug[1] + xfaug[2], xfaug[2]]
        ...
        outputs['total_loss'] = kl_loss*self.cfg.TRAIN.KL_WEIGHT+loc_loss
