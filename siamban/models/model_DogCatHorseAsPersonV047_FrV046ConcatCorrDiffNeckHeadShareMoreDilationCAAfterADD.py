...
class AdjustAllLayerFPNAddFlagCenterCrop(nn.Module):
    def __init__(self, in_channels, out_channels, center_size=9):
        ...
        self.ca = ChannelAttention(out_channels[0], 64)
...
class ModelBuilder(nn.Module):
    def __init__(self,cfg=None):
        ...
        if cfg.BACKBONE.VARIANT=='s0':
            ...
            self.neckconcat = AdjustAllLayerFPNAddFlagCenterCrop(in_channels=[128,256,1024],out_channels=[192,192,192],center_size=9)
