...
class ModelBuilder(nn.Module):
    def __init__(self,cfg=None):
        ...
        # build adjust layer
        self.neck = AdjustAllLayerFPNAddFlagCenterCrop(in_channels=[128,256],out_channels=[192,192],center_size=9)


        # build rpn head
        self.head = RPNHead(cin=192,p=cfg.TRAIN.PROB_DROPOUT,pspatial=cfg.TRAIN.PROB_DROPOUTSPATIAL)
