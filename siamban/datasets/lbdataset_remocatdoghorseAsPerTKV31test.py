    ...
    def __init__(self,rank,world_size=None,batchsize=None):
        ...
        for name in cfg.DATASET.NAMES:
            ...
            if name in ["HeadNOFACECOCO","HeadNOFACEAIC"]:
                ...
                print(info1)
                logger.info(info1)
            elif name in ["REMOWIKICATHIGDOGANNORESULT20230525","REMOWIKICATHIGDOGANNORESULT20230526"]:
                for imgpath in data:
            ...
            if name in ["REMOWIKICATHIGDOGANNORESULT20230525","REMOWIKICATHIGDOGANNORESULT20230526"]:
                if len(cat_list) > 0:
