...
class BANDataset(Dataset):
    def __init__(self,world_size=None,batchsize=None):
        ...
        for name in cfg.DATASET.NAMES:
            ...
            if name in ["HeadNOFACECOCO","HeadNOFACEAIC"]:
                ...
                print(info1)
                logger.info(info1)
            elif name in ["REMANNONOTAILDATA230525230526IMAGE",]:
                for imgpath in data:
                    for box in data[imgpath]:
                        xmin, ymin, xmax, ymax, cid = box
                        boxinfo = ['remoimg', rootid, imgpath, [xmin, ymin, xmax, ymax], cid]
                        if cid == 1:
            ...
            if name in ["REMANNONOTAILDATA230525230526IMAGE",]:
                if len(cat_list) > 0:
    ...
    def __getitem__(self, index):
        ...
        for idx, dinfo in enumerate(self.datalist_pos[index%self.videos_per_epoch]):
            ...
            # print(dinfo)
            if dsettag=="remoimg":
                rootid, imgpath, bbox_prev, cid = dinfo[1:]
    ...
    def MakeExamplesCropTemplate(self, num_generated_examples, image_prev, image_curr, bbox_prev, bbox_curr, seggt=None):
        ...
        I_currs, box_gts, segs = self.MakeTrainingExamplesCropedTemplate(num_generated_examples, bbox_fake,image_curr, bbox_curr, seggt)
...
if __name__ == '__main__':
    ...
    """
    cfgfile = "/home/inspur/work/siamban_GOTREMO/experiments/siamban_r50_l234/20230526DogCatHorseAsPersonV035_FrV022FourGPUOneClsFixedBBAddWeight_DV14_4GPU128.yaml"
    ...
    for i in idlist:
        ...
        print(search.shape,template.shape,boxes_gt_all.shape,len(label_posnegpair))
        nimg = search.shape[0]
