        ...
        for name in cfg.DATASET.NAMES:
            ...
            if name in ["HeadNOFACECOCO","HeadNOFACEAIC"]:
                ...
                logger.info(info1)
                          ...
                          "REMOWIKICATHIGDOGANNORESULT20230407"]:
                for imgpath in data:
            ...
            if name in ['REMOCATDOGHORSE', 'REMOWIKICATHIGDOGANNORESULT20230328', 'REMOWIKICATHIGDOGANNORESULT20230331',
                        'REMOWIKICATHIGDOGANNORESULT20230407', 'REMOWIKICATHIGDOGANNORESULT20230324', 'COCO', 'DET']:
                if len(cat_list) > 0:
