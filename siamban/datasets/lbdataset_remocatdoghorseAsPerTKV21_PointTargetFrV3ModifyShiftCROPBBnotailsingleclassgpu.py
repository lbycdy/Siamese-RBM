    ...
    def __init__(self,world_size=None,batchsize=None):
        ...
        for name in cfg.DATASET.NAMES:
            ...
            if name in ["HeadNOFACECOCO","HeadNOFACEAIC"]:
                ...
                print(info1)
                logger.info(info1)
            elif name in ["REMOCATDOGHORSE", "REMOWIKICATHIGDOGANNORESULT20230324",
                          "REMOWIKICATHIGDOGANNORESULT20230328", "REMOWIKICATHIGDOGANNORESULT20230331",
                          "REMOWIKICATHIGDOGANNORESULT20230407", "REMOWIKICATHIGDOGANNORESULT20230427"]:
                for imgpath in data:
            ...
            if random.uniform(0,1.0)<cfg.DATASET.CATDOGHORSETK.PROB_IMG:
                ...
                if random.uniform(0.0, 1.0) < cfg.DATASET.CATDOGHORSETK.MAKEEAAMPLES1PROB:
                    ...
                    if MAKEEAAMPLES1FLAG == 0:
                        imgs_prev_temp.extend([I_prev_list[0]] * 16)
                    ...
                    if MAKEEAAMPLES1FLAG == 0:
                        imgs_prev_temp.extend([I_prev] * 16)
