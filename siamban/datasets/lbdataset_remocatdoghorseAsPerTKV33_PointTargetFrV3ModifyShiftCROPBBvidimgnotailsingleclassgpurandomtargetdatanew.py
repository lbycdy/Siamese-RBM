...
class BANDataset(Dataset):
    def __init__(self,world_size=None,batchsize=None):
        ...
        for name in cfg.DATASET.NAMES:
            ...
            elif name in ['REMANNONOTAILDATA230525230526VIDEO','LASOT1', 'GOT10K1', 'VID1']:
                if len(cat_list) > 0:
    ...
    def shuffledata(self):
        ...
        for i in range(numiter):
            ...
            for igpu in range(4):
                di = []
                for _ in range(cfg.DATASET.CATDOGHORSETK.FETCH_ITERS): #cfg.DATASET.CATDOGHORSETK.FETCH_ITERS==4
    ...
    def __getitem__(self, index):
        ...
        cidlist = []
        # print('###############3',len(self.datalist_pos))
        # exit()
        for dinfo in self.datalist_pos[index%self.videos_per_epoch]:
            dsettag = dinfo[0]
            if dsettag=="remoimg":
