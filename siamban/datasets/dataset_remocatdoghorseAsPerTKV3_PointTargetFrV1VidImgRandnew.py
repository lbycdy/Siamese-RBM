...
class BANDataset(Dataset):
    def __init__(self,world_size=None,batchsize=None):
        ...
        self.lambda_min_scale_ = cfg.DATASET.CATDOGHORSETK.LAMBDA_MIN_SCALE
        self.lambda_max_scale_ = cfg.DATASET.CATDOGHORSETK.LAMBDA_MAX_SCALE
    ...
    def __getitem__(self, index):
        ...
        if random.uniform(0,1.0)<cfg.DATASET.CATDOGHORSETK.PROB_CROPTEMPLATE: #0.7
            sizehalf = self.resizedw_temp/2
            sx = random.uniform(cfg.DATASET.CATDOGHORSETK.SCALE_CROPTEMPLATE,1.0)  #(0.7-1.0)
...
if __name__ == '__main__':
    ...
    get qt data
    """
    cfgfile = "/home/inspur/work/siamban_GOTREMO/experiments/siamban_r50_l234/20221228DogCatHorseAsPersonV005MobileOneS16S32WeightAdd_DV3VIRandPNMod1SFTMod1SNegHeadP0.3PutP0.3In160_4GPU128.yaml"
