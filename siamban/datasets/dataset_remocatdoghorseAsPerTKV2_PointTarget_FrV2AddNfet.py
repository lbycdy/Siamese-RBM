...
class BANDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for ifetch in range(cfg.DATASET.CATDOGHORSETK.FETCH_ITERS):
            ...
            boxes_gt_all.extend(bboxes_gt)
            label_posnegpair.extend([1]*len(imgs_curr))
            I_prevVid_all.append(I_prev)
        if random.uniform(0,1.0)<cfg.DATASET.CATDOGHORSETK.PROB_TEMPLATEFROMIMG:
            I_prev = random.choice(I_prevImg_all)
        else:
            I_prev = random.choice(I_prevVid_all)
...
if __name__ == '__main__':
    ...
    # cfgfile = "/home/inspur/work/siamban-acm/experiments/siamban_r50_l234/20221115DogCatHorseAsPersonV001MobileV2S16S32WeightAdd_ACMOutPointMask_4GPU127.yaml"
    ...
    # cfg.DATASET.CATDOGHORSETK.KCONTEXTFACTORSHIFTBOX = 2.8
    # cfg.TRAIN.EPOCH = 2
    # data = BANDataset()
