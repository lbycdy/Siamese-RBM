...
class BANDataset(Dataset):
    ...
    def get_detection_image_bboxes(self, idx):
        ...
        det_img = cv2.imread(det_imgpath)
...
if __name__ == '__main__':
    ...
    cfg.DATASET.COCO.ROOT = '/home/lbycdy/datasets/OCean/coco/crop511'
    cfg.DATASET.COCO.ANNO = '/home/lbycdy/datasets/OCean/coco/train2017.json'
