...
from siamban.models.model_DogCarHorseV001GOTMobileOne_CorrAndWeightAdd_rankloss import ModelBuilder
from siamban.datasets.dataset_remocatdoghorsev1 import BANDataset
from siamban.datasets.dataset_remocatdoghorsev2 import BANDataset as BANDatasetV2
from siamban.datasets.dataset_remocatdoghorsev2_OneClass import BANDataset as BANDatasetV2OneCls
...
class Trainer:
    ...
    def init_datasets(self):
        ...
        if cfg.DATASET.DATASETID==0:
            train_dataset = BANDataset(world_size=self.world_size,batchsize=cfg.TRAIN.BATCH_SIZE,cfg=cfg)
        elif cfg.DATASET.DATASETID==1:
            train_dataset = BANDatasetV2(world_size=self.world_size,batchsize=cfg.TRAIN.BATCH_SIZE,cfg=cfg)
        elif cfg.DATASET.DATASETID==2:
            train_dataset = BANDatasetV2OneCls(world_size=self.world_size,batchsize=cfg.TRAIN.BATCH_SIZE,cfg=cfg)
