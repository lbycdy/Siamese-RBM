...
from siamban.models.lbmodel_DogCatHorseAsPersonV015PerTKMobileOneWeightAddsingleclass_ACMOutPointMask_HeadPadding import ModelBuilder
...
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV20_PointTargetFrV3ModifyShiftCROPBBsingleclassgpucroptem  import BANDataset as BANDatasetV20
...
class Trainer:
    ...
    def init_datasets(self,rank):
        ...
        elif cfg.DATASET.DATASETID == 20:
            train_dataset = BANDatasetV20(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
