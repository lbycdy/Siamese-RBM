...
args.config = "/home/lbycdy/work/siamban/experiments/siamban_r50_l234/lb20230705DogCatHorseAsPersonV041_FrV039ConcatSearchFeatAffCorrDV38MultGTAsDetCropTCat0.5Other0.1S0.6MaxS0.75SFT1PS3.0covea0.3newdatavidpermasksamplelist_4GPU127.yaml"

args.snapshot = '/home/lbycdy/checkpoint/lb20230705DogCatHorseAsPersonV041_FrV039ConcatSearchFeatAffCorrDV38MultGTAsDetCropTCat0.5Other0.1S0.6MaxS0.75SFT1PS3.0covea0.3newdatavidpermasksamplelist_4GPU127/checkpoint_e1_param.pth'
...
# video_name = "/home/lbycdy/datasets/DogCatHorseVideo/Video1103/Horse/Horse08.mp4"
...
def main():
    ...
    for frame in get_frames(args.video_name,videogap):
        if first_frame:
            ...
            x_crop, scalex, scaley, imgshow,cropleft,croptop  = getnetinput(frame, center_pos, size,
                                                                              flagsearch=True)
