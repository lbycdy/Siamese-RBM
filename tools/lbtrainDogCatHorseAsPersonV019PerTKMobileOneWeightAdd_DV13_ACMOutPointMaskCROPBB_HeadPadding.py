...
from siamban.models.lbmodel_DogCatHorseAsPersonV019PerTKMobileOneWeightAddsingleclasscroptem_ACMOutPointMask_HeadPadding import ModelBuilder
...
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV26_PointTargetFrV3ModifyShiftCROPBBvidimgnotailsingleclassgpucroptemnoneg import BANDataset as BANDatasetV26
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV27_PointTargetFrV3ModifyShiftCROPBBvidimgnotailsingleclassgpucroptemshiftS import BANDataset as BANDatasetV27
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV28_PointTargetFrV3ModifyShiftCROPBBvidimgnotailsingleclassgpucroptemshiftSclass import BANDataset as BANDatasetV28
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV29_PointTargetFrV3ModifyShiftCROPBBvidimgnotailsingleclassgpucroptemshiftSclassnonneg import BANDataset as BANDatasetV29
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV25_PointTargetFrV3ModifyShiftCROPBBvidimgnotailsingleclassgpucroptemnoneg import BANDataset as BANDatasetV25
...
class Trainer:
    ...
    def init_datasets(self):
        ...
        elif cfg.DATASET.DATASETID == 25:
            train_dataset = BANDatasetV25(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 26:
            train_dataset = BANDatasetV26(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 27:
            train_dataset = BANDatasetV27(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 28:
            train_dataset = BANDatasetV28(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 29:
            train_dataset = BANDatasetV29(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 30:
            train_dataset = BANDatasetV30(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
