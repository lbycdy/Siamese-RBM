...
from siamban.models.model_DogCatHorseAsPersonV001MobileV2S16S32WeightAdd_ACMOutPointMask import ModelBuilder
from siamban.datasets.dataset_remocatdoghorseAsPerTKV1_PointTarget import BANDataset
...
elif ipaddress_int in [126,127,125]:
...
class Trainer:
    ...
    def init_model(self):
        ...
        if cfg.BACKBONE.PRETRAINED:
            ...
            logger.info(self.model.backbone.loadfrompretrain(cfg.BACKBONE.PRETRAINED))
