...
from siamban.models.lbmodel_DogCatHorseAsPersonV013PerTKMobileOneWeightAddS16S32_ACMOutPointMaskDropHWCenterRK_HeadPadding import ModelBuilder
...
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV10_PointTargetFrV3ModifyShiftCROPBBTEST import BANDataset as BANDatasetV10
...
class Trainer:
    ...
    def init_datasets(self):
        ...
        elif cfg.DATASET.DATASETID == 10:
            train_dataset = BANDatasetV10(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
