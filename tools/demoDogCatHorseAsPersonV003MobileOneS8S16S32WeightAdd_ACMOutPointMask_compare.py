...
args.config = "/home/lbycdy/work/siamban/experiments/siamban_r50_l234/20230210DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod1SFTMod6SIn160ModScalenoranklossCoveA0.5LAMBDA1.0pointstride10_4GPU122.yaml"
args.snapshot1 = '/home/lbycdy/checkpoint/20230210DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod1SFTMod6SIn160ModScalenoranklossCoveA0.5LAMBDA1.0pointstride10_4GPU122/checkpoint_e12_param.pth'
args.snapshot2 = '/home/lbycdy/checkpoint/20230210DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod1SFTMod6SIn160ModScalenoranklossCoveA0.5LAMBDA1.0pointstride10_4GPU122/checkpoint_e9_param.pth'
...
def main():
    ...
    for frame in get_frames(args.video_name,videogap):
        if first_frame:
            ...
            x_crop1, scalex1, scaley1, imgshow1 = getnetinput(frame, center_pos1, size1, flagsearch=True)
            x_crop2, scalex2, scaley2, imgshow2 = getnetinput(frame, center_pos2, size2, flagsearch=True)
            print(x_crop1.size(), ":x_crop1")
            print(x_crop2.size(), ":x_crop2")
