...
# args.config = "/home/ethan/work/siamban_GOTREMO/experiments/siamban_r50_l234/lb20230216DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod1TYPECONTEXT4SFTMod7SIn160onlyLocdatasetid2_4GPU122.yaml"
# args.snapshot = '/home/ethan/Models/Results/0016_GOT/lb20230216DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod1TYPECONTEXT4SFTMod7SIn160onlyLocdatasetid2_4GPU122/checkpoint_e11_param.pth'


args.config = "/home/lbycdy/work/siamban/experiments/siamban_r50_l234/lb20230220DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod1TYPECONTEXT4SFTMod7SIn160onlyLocdatasetid2_4GPU122.yaml"
args.snapshot = '/home/lbycdy/checkpoint/lb20230220DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod1TYPECONTEXT4SFTMod7SIn160onlyLocdatasetid2_4GPU122/checkpoint_e13_param.pth'



# args.config = "/home/ethan/work/siamban_GOTREMO/experiments/siamban_r50_l234/lb20230226DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod0TYPECONTEXT0SFTMod2SIn160onlyLocdatasetid2_4GPU127.yaml"
# args.snapshot = '/home/ethan/Models/Results/0016_GOT/lb20230226DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod0TYPECONTEXT0SFTMod2SIn160onlyLocdatasetid2_4GPU127/checkpoint_e10_param.pth'
...
# video_name = "/media/ethan/OldDisk/home/ethan/test_videos/DogCatHorseVideo/Video1103/Cat/Cat10.mp4"
...
def main():
    ...
    cnt = 0
    print(cfg.DATASET.CATDOGHORSETK.TYPE_CONTEXTBOX)
    for frame in get_frames(args.video_name,videogap):
        ...
        if first_frame:
            try:
                ...
                pass
            # init_rect = (462, 716, 217, 161)

            if sum(init_rect)!=0:
                print(cnt, "init_rect:",init_rect)
                ...
                print(model.zf.size(), ":zfm1",model.zf.min().data.cpu().numpy(),model.zf.max().data.cpu().numpy(),model.zf.mean().data.cpu().numpy())
                first_frame = False
        else:
            if cfg.DATASET.CATDOGHORSETK.TYPE_CONTEXTBOX == 4:
