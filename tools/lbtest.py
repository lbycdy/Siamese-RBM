...
from siamban.models.lbmodel_DogCatHorseAsPersonV017PerTKMobileOneWeightAddS16S32CATS8singleclass4gpu_ACMOutPointMaskDropHWCenterRK_HeadPadding import ModelBuilder
...
args.config = "/home/lbycdy/work/siamban/experiments/siamban_r50_l234/lb20230428DogCatHorseAsPersonV017PerTKMobileOneWeightAdd_DV14VIRandPNMod3SFT7STK0min0.75Cov0.3In160NoRkCropbbERASEPS3_4GPU127.yaml"
# args.config = "/home/lbycdy/work/siamban/experiments/siamban_r50_l234/lb20230426DogCatHorseAsPersonV017PerTKMobileOneWeightAdd_DV14VIRandPNMod3SFT7STK0min0.75Cov0.3In160NoRkCropbbERASEPS3_4GPU122.yaml"

args.snapshot = '/home/lbycdy/checkpoint/lb20230428DogCatHorseAsPersonV017PerTKMobileOneWeightAdd_DV14VIRandPNMod3SFT7STK0min0.75Cov0.3In160NoRkCropbbERASEPS3_4GPU127/checkpoint_e8_param.pth'
# args.snapshot = '/home/lbycdy/checkpoint/lb20230426DogCatHorseAsPersonV017PerTKMobileOneWeightAdd_DV14VIRandPNMod3SFT7STK0min0.75Cov0.3In160NoRkCropbbERASEPS3_4GPU122/checkpoint_e6_param.pth'
...
# video_name = "/home/lbycdy/datasets/OCean/LaSOT/img/cattle/cattle-18/img"
video_name =  "/home/lbycdy/Videos/vlc-record-2023-04-28-21h34m45s-ch05_20200929175336.mp4-.mp4"
video_name = '/home/lbycdy/Videos/vlc-record-2023-04-28-21h25m19s-ch05_20200927072018.mp4-.mp4'
video_name = '/home/lbycdy/Videos/vlc-record-2023-04-28-21h12m01s-ch05_20201006120025.mp4-.mp4'
...
def main():
    ...
    # out = cv2.VideoWriter('output.mp4', fourcc, 30, (1920, 1080), True)
    i = 0
    for frame in get_frames(args.video_name,videogap):
        if first_frame:
            ...
            # cv2.imwrite('result%s.jpg'%i,add_img)
            ...
            if cfg.DATASET.CATDOGHORSETK.TYPE_CONTEXTBOX == 0:
                ...
                szpred = np.sqrt(pred_bbox[2, :] * pred_bbox[3, :])
                s = np.sqrt(size[0] * scalex * size[1] * scaley)
                s_c = change(szpred / s)
                r = size[0] * scalex / (size[1] * scaley)
                r_c = change(r /
                              (pred_bbox[2, :] / pred_bbox[3, :]))
                print("s1:r1---", s, r)
            ...
            cv2.imwrite('/home/lbycdy/datasets/OCean/LaSOT/img/cattle/1/video%s.jpg'%i,frame)
            # out.write(frame)
            key = cv2.waitKey(0)
            if key == 27:
                exit()
