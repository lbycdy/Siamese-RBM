...
from siamban.datasets.dataset_remocatdoghorseAsPerTKV14_NotailFourGPUOneCls import BANDataset as BANDatasetV14
from siamban.datasets.dataset_remocatdoghorseAsPerTKV15_NotailFourGPUOneClsFrV14CropTemplateAndSearch import BANDataset as BANDatasetV15
from siamban.datasets.dataset_remocatdoghorseAsPerTKV16_NotailFourGPUOneClsFrV15ModifyCropTemplateBug import BANDataset as BANDatasetV16

from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV36_NotailFourGPUOneClsFrV18DetGTinCATADDPER import BANDataset as BANDatasetV36
from siamban.datasets.dataset_remocatdoghorseAsPerTKV19_NotailFourGPUOneClsFrV18DetGTinDataset import BANDataset as BANDatasetV19
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV34_NotailFourGPUOneClsFrV18DetGTinDatasetaddper import BANDataset as BANDatasetV34
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV37_NotailFourGPUOneClsFrV18DetGTinCATADDPER import BANDataset as BANDatasetV37
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV38_NotailFourGPUOneClsFrV18DetGTinCATpermask import BANDataset as BANDatasetV38
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV39_NotailFourGPUOneClsFrV18DetGTinCATpermask  import BANDataset as BANDatasetV39
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV35_NotailFourGPUOneClsFrV18DetGTinCATADDPER import BANDataset as BANDatasetV35
...
elif ipaddress_int in [126,125,128]:
    modelsaveroot = "/home/inspur/Models/Results/0016_GOT"
elif ipaddress_int in [127,]:
    modelsaveroot = "/mnt/DataHDD//Models/Results/0016_GOT"
...
class Trainer:
    ...
    def init_datasets(self):
        ...
        elif cfg.DATASET.DATASETID == 19:
            train_dataset = BANDatasetV19(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 34:
            train_dataset = BANDatasetV34(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 35:
            train_dataset = BANDatasetV36(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 36:
            train_dataset = BANDatasetV36(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 37:
            train_dataset = BANDatasetV37(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 38:
            train_dataset = BANDatasetV38(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 39:
            train_dataset = BANDatasetV39(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
    ...
    def train(self):
        ...
        for idx, data in enumerate(self.train_loader):
            ...
            if epoch != idx // num_per_epoch + start_epoch:
                self.train_loader.dataset.shuffledata()
