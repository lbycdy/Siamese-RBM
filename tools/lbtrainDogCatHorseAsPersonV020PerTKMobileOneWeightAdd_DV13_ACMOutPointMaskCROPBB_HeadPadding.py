...
from siamban.models.lbmodel_DogCatHorseAsPersonV020PerTKMobileOneWeightAddS16S32singleclass4gpucroptem_ACMOutPointMaskDropHWCenterRK_HeadPadding import ModelBuilder
...
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV23_PointTargetFrV3ModifyShiftCROPBBvidimgnotailsingleclassgpucroptem import BANDataset as BANDatasetV23
...
class Trainer:
    ...
    def init_datasets(self):
        ...
        elif cfg.DATASET.DATASETID == 23:
            train_dataset = BANDatasetV23(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
