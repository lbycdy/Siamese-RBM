...
# args.config = "/home/lbycdy/work/siamban/experiments/siamban_r50_l234/lb20230523DogCatHorseAsPersonV016PerTKMobileOneWeightAdd_DV30VIRandPNMod3SFT7STK1min0.5Cov0.2In160NoRkCropbbERASEPS3probt1.0scalet0.3notailscaleneg1.0_4GPU127.yaml"
args.config ="/home/lbycdy/work/siamban/experiments/siamban_r50_l234/lb20230523DogCatHorseAsPersonV016PerTKMobileOneWeightAdd_DV30VIRandPNMod3SFT7STK1min0.5Cov0.2In160NoRkCropbbERASEPS3probt1.0scalet0.3notailscaleneg1.0pos2.0_4GPU127.yaml"
# args.snapshot = '/home/lbycdy/checkpoint/lb20230523DogCatHorseAsPersonV016PerTKMobileOneWeightAdd_DV30VIRandPNMod3SFT7STK1min0.5Cov0.2In160NoRkCropbbERASEPS3probt1.0scalet0.3notailscaleneg1.0_4GPU127/checkpoint_e18_param.pth'
args.snapshot = '/home/lbycdy/checkpoint/lb20230523DogCatHorseAsPersonV016PerTKMobileOneWeightAdd_DV30VIRandPNMod3SFT7STK1min0.5Cov0.2In160NoRkCropbbERASEPS3probt1.0scalet0.3notailscaleneg1.0pos2.0_4GPU127/checkpoint_e15_param.pth'
...
def getnetinput2(image,center_pos,size,flagsearch):
    ...
    ymax = min(ymax, im_h)
    imgcrop = image[ymin:ymax, xmin:xmax, :]
    img_pad = cv2.copyMakeBorder(imgcrop, padtop, padbottom, padleft, padright, cv2.BORDER_CONSTANT, value=(117, 117, 117))
    h1, w1 = img_pad.shape[:2]
    if cfg.DATASET.CATDOGHORSETK.FLAG_TEMPLATESEARCH_SIZEFROMCONFIG:
        if flagsearch:
            im_patch = cv2.resize(img_pad, (cfg.TRAIN.SEARCH_SIZE, cfg.TRAIN.SEARCH_SIZE))
