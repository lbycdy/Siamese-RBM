...
# args.config = "/home/lbycdy/work/siamban/experiments/siamban_r50_l234/lb20230626DogCatHorseAsPersonV041_FrV039ConcatSearchFeatAffCorrDV36MultGTAsDetCropTCat0.5Other0.1S0.6MaxS0.75SFT1PS3.0covea0.3newdatavidCATADDPER_4GPU127.yaml"
#
# args.snapshot = '/home/lbycdy/checkpoint/lb20230626DogCatHorseAsPersonV041_FrV039ConcatSearchFeatAffCorrDV36MultGTAsDetCropTCat0.5Other0.1S0.6MaxS0.75SFT1PS3.0covea0.3newdatavidCATADDPER_4GPU127/checkpoint_e15_param.pth'


args.config = "/home/lbycdy/work/siamban/experiments/siamban_r50_l234/lb20230707DogCatHorseAsPersonV041_FrV039ConcatSearchFeatAffCorrDV38MultGTAsDetCropTCat0.5Other0.1S0.6MaxS0.75SFT1PS3.0covea0.3newdatavidpermasktestsamplelist_4GPU127.yaml"

args.snapshot = '/home/lbycdy/checkpoint/lb20230707DogCatHorseAsPersonV041_FrV039ConcatSearchFeatAffCorrDV38MultGTAsDetCropTCat0.5Other0.1S0.6MaxS0.75SFT1PS3.0covea0.3newdatavidpermasktestsamplelist_4GPU127/checkpoint_e4_param.pth'
...
# video_name = "/home/lbycdy/datasets/DogCatHorseVideo/Video1103/Dog/Dog05.mp4"
videogap = 3
...
def main():
    ...
    for frame in get_frames(args.video_name,videogap):
        ...
        if first_frame:
            ...
            print('11111',pred_bbox.shape)
            pred_bbox_good = pred_bbox[:,idx[:40]]
            print('22222',score.shape,pred_bbox.shape)
            flag = score>0.8
