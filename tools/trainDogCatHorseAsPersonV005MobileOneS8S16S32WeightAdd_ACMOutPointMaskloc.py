...
from siamban.datasets.dataset_remocatdoghorseAsPerTKV6_PointTargetFrV3ModifyShiftLoc import BANDataset as BANDatasetV05
...
def build_opt_lr(model, current_epoch=0):
    ...
    trainable_params += [{'params': model.head.parameters(),
                          'lr': cfg.TRAIN.BASE_LR}]
    trainable_params += [{'params': model.head1.parameters(),
                          'lr': cfg.TRAIN.BASE_LR}]
