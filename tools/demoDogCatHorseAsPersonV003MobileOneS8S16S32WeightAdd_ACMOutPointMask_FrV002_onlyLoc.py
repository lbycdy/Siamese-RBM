...
args.config = "/home/lbycdy/work/siamban/experiments/siamban_r50_l234/lb20230228DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod1TYPECONTEXT0SFTMod2SIn160onlyLocdatasetid2pretrain_3GPU122.yaml"
args.snapshot1 = '/home/lbycdy/checkpoint/lb20230228DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod1TYPECONTEXT0SFTMod2SIn160onlyLocdatasetid2pretrain_3GPU122/checkpoint_e2_param.pth'
args.snapshot2 = '/home/lbycdy/checkpoint/lb20230228DogCatHorseAsPersonV003MobileOneS8S16S32Add_ACMOutPointMaskDV3VIRandPNMod1TYPECONTEXT0SFTMod2SIn160onlyLocdatasetid2pretrain_3GPU122/checkpoint_e2_param.pth'


# video_name = "/media/ethan/OldDisk/home/ethan/test_videos/DogCatHorseVideo/Video1103/Cat/Cat01.mp4"
    ...
    for frame in get_frames(args.video_name, videogap):
        ...
        if first_frame:
            ...
            if cfg.DATASET.CATDOGHORSETK.TYPE_CONTEXTBOX == 4:
                x_crop1, scalex1, scaley1, imgshow1,x_croproi1= getnetinput1(frame, center_pos1, size1, flagsearch=True)
                x_crop2, scalex2, scaley2, imgshow2,x_croproi2= getnetinput1(frame, center_pos2, size2, flagsearch=True)
            else:
