...
from siamban.models.lbmodel_DogCatHorseAsPersonV016PerTKMobileOneWeightAddS16S32singleclass4gpu_ACMOutPointMaskDropHWCenterRK_HeadPadding import ModelBuilder
...
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV07_PointTargetFrV3ModifyShiftCROPBB import BANDataset as BANDatasetV07
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV14_PointTargetFrV3ModifyShiftCROPBBsingleclassgpu  import BANDataset as BANDatasetV14
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV15_PointTargetFrV3ModifyShiftCROPBBnotailsingleclassgpu import BANDataset as BANDatasetV15
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV16_PointTargetFrV3ModifyShiftCROPBBnotailsingleclassgpuTeqS import BANDataset as BANDatasetV16
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV17_PointTargetFrV3ModifyShiftCROPBBnotail import BANDataset as BANDatasetV17
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV18_PointTargetFrV3ModifyShiftCROPBBnotail import BANDataset as BANDatasetV18
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV22_PointTargetFrV3ModifyShiftCROPBBvidimgnotailsingleclassgpu import  BANDataset as BANDatasetV22
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV24_PointTargetFrV3ModifyShiftCROPBBvidimgnotailsingleclassgpu import  BANDataset as BANDatasetV24
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV31test import  BANDataset as BANDatasetV31
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV30_PointTargetFrV3ModifyShiftCROPBBvidimgnotailsingleclassgpurandomtarget import  BANDataset as BANDatasetV30
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV33_PointTargetFrV3ModifyShiftCROPBBvidimgnotailsingleclassgpurandomtargetdatanew import  BANDataset as BANDatasetV33
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV32_PointTargetFrV3ModifyShiftCROPBBvidimgnotailsingleclassgpurandomtargetdatanew import  BANDataset as BANDatasetV32
from siamban.datasets.lbdataset_remocatdoghorseAsPerTKV13_PointTargetFrV3ModifyShiftCROPBBsingleclass  import BANDataset as BANDatasetV13
...
elif ipaddress_int == 15:
    modelsaveroot = '/home/lbycdy'
...
def build_opt_lr(model, current_epoch=0):
    ...
    trainable_params += [{'params': filter(lambda x: x.requires_grad,
                          ...
                          'lr': cfg.BACKBONE.LAYERS_LR * cfg.TRAIN.BASE_LR, 'weight_decay': cfg.TRAIN.WEIGHT_DECAY_BB}]
...
class Trainer:
    ...
    def init_datasets(self):
        ...
        elif cfg.DATASET.DATASETID == 3:
            train_dataset = BANDatasetV07(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 13:
            train_dataset = BANDatasetV13(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 14:
            train_dataset = BANDatasetV14(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 15:
            train_dataset = BANDatasetV15(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 16:
            train_dataset = BANDatasetV16(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 17:
            train_dataset = BANDatasetV17(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 18:
            train_dataset = BANDatasetV18(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 22:
            train_dataset = BANDatasetV22(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 24:
            train_dataset = BANDatasetV24(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 30:
            train_dataset = BANDatasetV30(self.rank,world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 31:
            train_dataset = BANDatasetV31(self.rank,world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 32:
            train_dataset = BANDatasetV32(self.rank,world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
        elif cfg.DATASET.DATASETID == 33:
            train_dataset = BANDatasetV33(world_size=self.world_size, batchsize=cfg.TRAIN.BATCH_SIZE)
