...
from siamban.models.lbmodel_DogCatHorseAsPersonV042_FrV039ConcatSearchS8S16FeatAffCorr import ModelBuilder
...
def build_opt_lr(model, current_epoch=0):
    ...
    trainable_params += [{'params': model.neck1.parameters(),
                              'lr': cfg.TRAIN.BASE_LR}]
    trainable_params += [{'params': model.neck2.parameters(),
                          'lr': cfg.TRAIN.BASE_LR}]
